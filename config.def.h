...
static const char
    *altbarcmd = "${XDG_CONFIG_HOME:-$HOME/.config}/polybar/launch-polybar.sh "
...
static const int riodraw_matchpid =
    0; /* 0 or 1, indicates whether to match the PID of the client that was
...
static const char *scratchpadcmd[] = {
    "s",         "scratchpad", "--class",    "Scratchpad", "--name",
    "spterm",    "--title",    "Scratchpad", "--lines",    "24",
    "--columns", "80",         NULL};
static const char *scratchpadcmd2[] = {"r",          "scratchpad",
                                       "--class",    "Scratchpad",
                                       "--name",     "spfilemanager",
                                       "--title",    "File Manager",
                                       "--lines",    "24",
                                       ...
                                       "--command",  "ranger",
                                       NULL};
static const char *scratchpadcmd3[] = {
    "m",         "scratchpad",
    "--class",   "Scratchpad",
    "--name",    "spmusic",
    "--title",   "Music",
    ...
    NULL};
static const char *scratchpadcmd4[] = {
    "c",         "scratchpad", "--class",    "Scratchpad", "--name",
    "spcalc",    "--title",    "Calculator", "--lines",    "24",
    "--columns", "80",         "--command",  "qalc",       NULL};
static const char *scratchpadcmd5[] = {
    "x",         "scratchpad", "--class",      "Scratchpad", "--name",
    "sppython",  "--title",    "Python Shell", "--lines",    "24",
    "--columns", "80",         "--command",    "bpython",    NULL};
static const char *scratchpadcmd6[] = {
    "h",
    "scratchpad",
    "--class",
    "Scratchpad",
    ...
    "80",
    "--command",
    "tmux -s Scratchpad-Top new-session -n htop htop \; new-window -n nvtop "
    "nvtop \; new-window -n btop btop \; select-window -t 1 \; attach",
    NULL};
...
static const Rule rules[] = {
    ...
    RULE(.instance = "spterm", .scratchkey = 's', .isfloating = 1,
         .iscentered = 1,
         .isterminal = 1) RULE(.instance = "spfilemanager", .scratchkey = 'r',
                               .isfloating = 1, .iscentered = 1,
                               .isterminal = 1)
        RULE(.instance = "spmusic", .scratchkey = 'm', .isfloating = 1,
             .iscentered = 1,
             .isterminal = 1) RULE(.instance = "spcalc", .scratchkey = 'c',
                                   .isfloating = 1, .iscentered = 1,
                                   .isterminal = 1)
            RULE(.instance = "sppython", .scratchkey = 'x', .isfloating = 1,
                 .iscentered = 1, .isterminal = 1)
                RULE(.instance = "sphtop", .scratchkey = 'h', .isfloating = 1,
                     .iscentered = 1, .isterminal = 1)
                    RULE(.instance = "spterm", .scratchkey = 's',
                         .isfloating = 1, .iscentered = 1, .isterminal = 1)
                        RULE(.instance = "spfilemanager", .scratchkey = 'r',
                            ...
                            RULE(.instance = "spmusic", .scratchkey = 'm',
                                ...
                                RULE(.instance = "spcalc", .scratchkey = 'c',
                                     .isfloating = 1, .iscentered = 1,
                                     .isterminal = 1)
                                    RULE(.instance = "sppython",
                                         .scratchkey = 'x', .isfloating = 1,
                                         .iscentered = 1, .isterminal = 1)
                                        RULE(.instance = "sphtop",
                                             .scratchkey = 'h', .isfloating = 1,
                                             .iscentered = 1, .isterminal = 1)};
...
static const char *dmenucmd[] = {
    ...
    selfgcolor,
    "-hp",
    "alacritty,arduino-ide,atlauncher,discord,filezilla,firefox,"
    "jellyfinmediaplayer,keepassxc,libreoffice,st,syncthingtray",
    NULL};
...
static const Key keys[] = {
    ...
    //{ MODKEY|ControlMask,           XK_p,          riospawnsync,           {.v
    //= dmenucmd } }, { MODKEY|ControlMask,           XK_Return,     riospawn,
    //{.v = termcmd } }, { MODKEY,                       XK_s, rioresize, {0} },
    ...
    //{ MODKEY|Mod1Mask,              XK_j,          inplacerotate,          {.i
    //= +2 } }, // same as rotatestack { MODKEY|Mod1Mask,              XK_k,
    //inplacerotate,          {.i = -2 } }, // same as reotatestack {
    //MODKEY|Mod1Mask|ShiftMask,    XK_j,          inplacerotate,          {.i =
    //+1} }, { MODKEY|Mod1Mask|ShiftMask,    XK_k,          inplacerotate, {.i =
    //-1} },
    ...
    //{ MODKEY|Mod1Mask,              XK_Down,       moveresize,             {.v
    //= "0x 25y 0w 0h" } }, { MODKEY|Mod1Mask,              XK_Up, moveresize,
    //{.v = "0x -25y 0w 0h" } }, { MODKEY|Mod1Mask,              XK_Right,
    //moveresize,             {.v = "25x 0y 0w 0h" } }, { MODKEY|Mod1Mask,
    //XK_Left,       moveresize,             {.v = "-25x 0y 0w 0h" } }, {
    //MODKEY|Mod1Mask|ShiftMask,    XK_Down,       moveresize,             {.v =
    //"0x 0y 0w 25h" } }, { MODKEY|Mod1Mask|ShiftMask,    XK_Up, moveresize, {.v
    //= "0x 0y 0w -25h" } }, { MODKEY|Mod1Mask|ShiftMask,    XK_Right,
    //moveresize,             {.v = "0x 0y 25w 0h" } }, {
    //MODKEY|Mod1Mask|ShiftMask,    XK_Left,       moveresize,             {.v =
    //"0x 0y -25w 0h" } },
    {MODKEY | ShiftMask, XK_j, movestack, {.i = +1}},
    {MODKEY | ShiftMask, XK_k, movestack, {.i = -1}},
    {MODKEY, XK_Return, zoom, {0}},
    //{ MODKEY|Mod1Mask,              XK_u,          incrgaps,               {.i
    //= +1 } }, { MODKEY|Mod1Mask|ShiftMask,    XK_u,          incrgaps, {.i =
    //-1 } }, { MODKEY|Mod1Mask,              XK_i,          incrigaps, {.i = +1
    //} }, { MODKEY|Mod1Mask|ShiftMask,    XK_i,          incrigaps, {.i = -1 }
    //}, { MODKEY|Mod1Mask,              XK_o,          incrogaps, {.i = +1 } },
    //{ MODKEY|Mod1Mask|ShiftMask,    XK_o,          incrogaps,              {.i
    ...
    //{ MODKEY|ControlMask,           XK_Left,       shiftboth,              {
    //.i = -1 } }, // note keybinding conflict with focusadjacenttag
    //tagandviewtoleft { MODKEY|ControlMask,           XK_Right,      shiftboth,
    //{ .i = +1 } }, // note keybinding conflict with focusadjacenttag
    //tagandviewtoright
    ...
    //{.v = &layouts[2]} }, { MODKEY,                       XK_c, setlayout, {.v
    //= &layouts[3]} }, { MODKEY,                       XK_space, setlayout, {0}
    //},
    ...
    /* { MODKEY|ControlMask,           XK_s,          setscratch, {.v =
       scratchpadcmd } }, */
    /* { MODKEY|ShiftMask,             XK_grave,      removescratch, {.v =
       scratchpadcmd } }, */
    ...
    //= -1 } }, { MODKEY,                       XK_period,     focusmon, {.i =
    //+1 } }, { MODKEY|ShiftMask,             XK_comma,      tagmon, {.i = -1 }
    //}, { MODKEY|ShiftMask,             XK_period,     tagmon, {.i = +1 } },
    {MODKEY, XK_n, togglealttag, {0}},
    //{ MODKEY,                       XK_KP_7,       explace, {.ui = EX_NW }},
    ///* XK_KP_Home,  */ { MODKEY,                       XK_KP_8,       explace,
    //{.ui = EX_N  }},   /* XK_KP_Up,    */ { MODKEY, XK_KP_9,       explace,
    //{.ui = EX_NE }},   /* XK_KP_Prior, */ { MODKEY, XK_KP_4,       explace,
    //{.ui = EX_W  }},   /* XK_KP_Left,  */ { MODKEY, XK_KP_5,       explace,
    //{.ui = EX_C  }},   /* XK_KP_Begin, */ { MODKEY, XK_KP_6,       explace,
    //{.ui = EX_E  }},   /* XK_KP_Right, */ { MODKEY, XK_KP_1,       explace,
    //{.ui = EX_SW }},   /* XK_KP_End,   */ { MODKEY, XK_KP_2,       explace,
    //{.ui = EX_S  }},   /* XK_KP_Down,  */ { MODKEY, XK_KP_3,       explace,
    //{.ui = EX_SE }},   /* XK_KP_Next,  */

    //{ MODKEY|ShiftMask,             XK_KP_8,       exresize,               {.v
    //= (int []){   0,  25 }}},  /* XK_KP_Up,    */ { MODKEY|ShiftMask, XK_KP_2,
    //exresize,               {.v = (int []){   0, -25 }}},  /* XK_KP_Down,  */
    //{ MODKEY|ShiftMask,             XK_KP_6,       exresize,               {.v
    //= (int []){  25,   0 }}},  /* XK_KP_Right, */ { MODKEY|ShiftMask, XK_KP_4,
    //exresize,               {.v = (int []){ -25,   0 }}},  /* XK_KP_Left,  */
    //{ MODKEY|ShiftMask,             XK_KP_5,       exresize,               {.v
    //= (int []){  25,  25 }}},  /* XK_KP_Begin, */ {
    //MODKEY|ShiftMask|ControlMask, XK_KP_5,       exresize,               {.v =
    //(int []){ -25, -25 }}},  /* XK_KP_Begin, */

    //{ MODKEY|ControlMask,           XK_KP_6,       togglehorizontalexpand, {.i
    //= +1} },  /* XK_KP_Right, */ { MODKEY|ControlMask,           XK_KP_3,
    //togglehorizontalexpand, {.i =  0} },  /* XK_KP_Next,  */ {
    //MODKEY|ControlMask,           XK_KP_4,       togglehorizontalexpand, {.i =
    //-1} },  /* XK_KP_Left,  */ { MODKEY|ControlMask,           XK_KP_8,
    //toggleverticalexpand,   {.i = +1} },  /* XK_KP_Up,    */ {
    //MODKEY|ControlMask,           XK_KP_1,       toggleverticalexpand,   {.i =
    //0} },  /* XK_KP_End,   */ { MODKEY|ControlMask,           XK_KP_2,
    //toggleverticalexpand,   {.i = -1} },  /* XK_KP_Down,  */ {
    //MODKEY|ControlMask,           XK_KP_9,       togglemaximize,         {.i =
    //-1} },  /* XK_KP_Prior, */ { MODKEY|ControlMask,           XK_KP_7,
    //togglemaximize,         {.i = +1} },  /* XK_KP_Home,  */ {
    //MODKEY|ControlMask,           XK_KP_5,       togglemaximize,         {.i =
    //0} },  /* XK_KP_Begin, */
    ...
    //{ Mod3Mask,                     XK_u,            floatpos, {.v = "-26x
    //-26y" } }, // ↖ { Mod3Mask,                     XK_i,            floatpos,
    //{.v = "  0x -26y" } }, // ↑ { Mod3Mask,                     XK_o,
    //floatpos,               {.v = " 26x -26y" } }, // ↗ { Mod3Mask, XK_j,
    //floatpos,               {.v = "-26x   0y" } }, // ← { Mod3Mask, XK_l,
    //floatpos,               {.v = " 26x   0y" } }, // → { Mod3Mask, XK_m,
    //floatpos,               {.v = "-26x  26y" } }, // ↙ { Mod3Mask, XK_comma,
    //floatpos,               {.v = "  0x  26y" } }, // ↓ { Mod3Mask, XK_period,
    //floatpos,               {.v = " 26x  26y" } }, // ↘
    /* Absolute positioning (allows moving windows between monitors) */
    //{ Mod3Mask|ControlMask,         XK_u,            floatpos, {.v = "-26a
    //-26a" } }, // ↖ { Mod3Mask|ControlMask,         XK_i,            floatpos,
    //{.v = "  0a -26a" } }, // ↑ { Mod3Mask|ControlMask,         XK_o,
    //floatpos,               {.v = " 26a -26a" } }, // ↗ {
    //Mod3Mask|ControlMask,         XK_j,            floatpos,               {.v
    //= "-26a   0a" } }, // ← { Mod3Mask|ControlMask,         XK_l, floatpos,
    //{.v = " 26a   0a" } }, // → { Mod3Mask|ControlMask,         XK_m,
    //floatpos,               {.v = "-26a  26a" } }, // ↙ {
    //Mod3Mask|ControlMask,         XK_comma,        floatpos,               {.v
    //= "  0a  26a" } }, // ↓ { Mod3Mask|ControlMask,         XK_period,
    //floatpos,               {.v = " 26a  26a" } }, // ↘
    /* Resize client, client center position is fixed which means that client
       expands in all directions */
    //{ Mod3Mask|ShiftMask,           XK_u,            floatpos, {.v = "-26w
    //-26h" } }, // ↖ { Mod3Mask|ShiftMask,           XK_i,            floatpos,
    //{.v = "  0w -26h" } }, // ↑ { Mod3Mask|ShiftMask,           XK_o,
    //floatpos,               {.v = " 26w -26h" } }, // ↗ { Mod3Mask|ShiftMask,
    //XK_j,            floatpos,               {.v = "-26w   0h" } }, // ← {
    //Mod3Mask|ShiftMask,           XK_k,            floatpos,               {.v
    //= "800W 800H" } }, // · { Mod3Mask|ShiftMask,           XK_l, floatpos,
    //{.v = " 26w   0h" } }, // → { Mod3Mask|ShiftMask,           XK_m,
    //floatpos,               {.v = "-26w  26h" } }, // ↙ { Mod3Mask|ShiftMask,
    //XK_comma,        floatpos,               {.v = "  0w  26h" } }, // ↓ {
    //Mod3Mask|ShiftMask,           XK_period,       floatpos,               {.v
    //= " 26w  26h" } }, // ↘
    /* Client is positioned in a floating grid, movement is relative to client's
       current position */
    //{ Mod3Mask|Mod1Mask,            XK_u,            floatpos, {.v = "-1p -1p"
    //} }, // ↖ { Mod3Mask|Mod1Mask,            XK_i,            floatpos, {.v =
    //" 0p -1p" } }, // ↑ { Mod3Mask|Mod1Mask,            XK_o, floatpos, {.v =
    //" 1p -1p" } }, // ↗ { Mod3Mask|Mod1Mask,            XK_j, floatpos, {.v =
    //"-1p  0p" } }, // ← { Mod3Mask|Mod1Mask,            XK_k, floatpos, {.v =
    //" 0p  0p" } }, // · { Mod3Mask|Mod1Mask,            XK_l, floatpos, {.v =
    //" 1p  0p" } }, // → { Mod3Mask|Mod1Mask,            XK_m, floatpos, {.v =
    //"-1p  1p" } }, // ↙ { Mod3Mask|Mod1Mask,            XK_comma, floatpos,
    //{.v = " 0p  1p" } }, // ↓ { Mod3Mask|Mod1Mask,            XK_period,
    //floatpos,               {.v = " 1p  1p" } }, // ↘
