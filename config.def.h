...
static const char *altbarcmd             = "$XDG_CONFIG_HOME/polybar/launch-top-polybar.sh"; /* Alternate bar launch command */
...
/* 	/1* monitor   bar    alignment         widthfunc                 drawfunc                clickfunc                hoverfunc                name *1/ */
